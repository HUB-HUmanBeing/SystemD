...
Template.calendarSettings.events({
    ...
    'click [exportICS]': function (e, instance) {
        e.preventDefault()
        let eventToExports = []
        let activities = Activity.find({projectId: FlowRouter.current().params.projectId, start: {$exists: true}}).fetch()
