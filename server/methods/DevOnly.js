...
//todo : MEGA FAILLE DE SECU, a enlever dès qu'on passe en prod!!!!
 function isAuthorizedToRunFixtures () {
    return Meteor.isDevelopment || Meteor.user().username === "admin"
}
                        ...
                        conversation.save((err, convId) => {
                            ...
                            user.profile.conversations.push({
                                ...
                                otherSpeakers: [{
                                    ...
                                    isProject : false,
                                    imgUrl :  Users[Fixtures.loopId(i + j)].profile.imgUrl,
                                    name :  Users[Fixtures.loopId(i + j)].username,
                                }],
                                vector : "",
                            ...
                            user.save(()=>{
                                ...
                                Users[Fixtures.loopId(i + j)].save()
                            })
                        })
                    }
                })
