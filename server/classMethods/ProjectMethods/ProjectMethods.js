...
Project.extend({
    meteorMethods: {
         ...
         *******************************/
        'createProject': function (projectName, brunchOfKeys) {
            ...
            this.publicInfo.asymPublicKey = brunchOfKeys.projectAsymPublicKey
            this.encryptedAsymPrivateKey = brunchOfKeys.encryptedAsymPrivateKey
